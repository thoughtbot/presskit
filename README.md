...
This site uses Sass to compile to static CSS. Run `sass --sourcemap=none --watch stylesheets/sass/base.scss:stylesheets/base.css` from the root directory if you make changes to any Sass files to recompile the CSS.
